<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        ...
        <div>
            <h4 class="logo-text">Laís Admin</h4>
        </div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route("all.brand") }}"><i class="bx bx-right-arrow-alt"></i>Listar</a>
                </li>
                <li> <a href="{{ route('add.brand') }}"><i class="bx bx-right-arrow-alt"></i>Cadastrar </a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route("all.category") }}"><i class="bx bx-right-arrow-alt"></i>Listar</a>
                </li>
                <li> <a href="{{ route('add.category') }}"><i class="bx bx-right-arrow-alt"></i>Cadastrar</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route("all.subcategory") }}"><i class="bx bx-right-arrow-alt"></i>Listar</a>
                </li>
                <li> <a href="{{ route('add.subcategory') }}"><i class="bx bx-right-arrow-alt"></i>Cadastrar</a>
                </li>
